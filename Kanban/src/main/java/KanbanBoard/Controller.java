...
public class Controller {
    ...
    private descriptionController contorl;


    private ObservableList<Button> cards =FXCollections.observableArrayList();
    private ObservableList<VBox> columns = FXCollections.observableArrayList();
    ...
    @FXML
    private void getCardDescription(String title)
    {
        try {

            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("cardDescription.fxml"));
